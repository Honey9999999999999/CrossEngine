...
namespace CrossEngine
{
    internal class TestScript : CrossBehaviour
    {
        ...
        public override void Start()
        {
            ...
            GameObject[] objects = [new("Sphere 1"), new("Sphere 2"), new("Sphere 2"), new("Sphere 2"), new("Sphere 2"), new("Sphere 2")];
        ...
        IEnumerator Render()
        {
            ...
            while (true)
            {
                ...
                //var hit = sphereList.Select(ray.Cast).Min();

                //Console.Title = $"{string.Join(", ", sphereList.Select(ray.Cast))}";
                //Console.SetCursorPosition(0, 0);
                //Console.Write(hit.Object?.ToString());
